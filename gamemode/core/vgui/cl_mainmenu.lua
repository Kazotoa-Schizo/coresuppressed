...
function PANEL:Init()
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			...
			button1x = Lerp(0.1, button1x, w)
		else
			self:SetColor(color_white)
			button1x = Lerp(0.1, button1x, 0)
		end
		
		surface.SetDrawColor(Color(60, 110, 60, 190))
		surface.DrawRect(0, h - 5, button1x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button2x = Lerp(0.1, button2x, w)
		else
			self:SetColor(color_white)
			button2x = Lerp(0.1, button2x, 0)
		end
		
		surface.SetDrawColor(Color(60, 110, 60, 190))
		surface.DrawRect(0, h - 5, button2x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button3x = Lerp(0.1, button3x, w)
		else
			self:SetColor(color_white)
			button3x = Lerp(0.1, button3x, 0)
		end
		
		surface.SetDrawColor(Color(60, 110, 60, 190))
		surface.DrawRect(0, h - 5, button3x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button4x = Lerp(0.1, button4x, w)
		else
			self:SetColor(color_white)
			button4x = Lerp(0.1, button4x, 0)
		end
		
		surface.SetDrawColor(Color(60, 110, 60, 190))
		surface.DrawRect(0, h - 5, button4x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button5x = Lerp(0.1, button5x, w)
		else
			self:SetColor(color_white)
			button5x = Lerp(0.1, button5x, 0)
		end
		
		surface.SetDrawColor(goldCol)
		surface.DrawRect(0, h - 5, button5x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button6x = Lerp(0.1, button6x, w)
		else
			self:SetColor(color_white)
			button6x = Lerp(0.1, button6x, 0)
		end
		
		surface.SetDrawColor(Color(60, 110, 60, 190))
		surface.DrawRect(0, h - 5, button6x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button7x = Lerp(0.1, button7x, w)
		else
			self:SetColor(color_white)
			button7x = Lerp(0.1, button7x, 0)
		end
		
		surface.SetDrawColor(highlightCol)
		surface.DrawRect(0, h - 5, button7x, 5)
	end
	...
	function button:Paint(w, h)
		if self:IsHovered() then
			self:SetColor(highlightCol)
			button8x = Lerp(0.1, button8x, w)
		else
			self:SetColor(color_white)
			button8x = Lerp(0.1, button8x, 0)
		end
	end
