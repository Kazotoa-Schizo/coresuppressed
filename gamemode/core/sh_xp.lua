...
if SERVER then
	...
	function meta:GiveTimedXP()
		if self:IsDonator() then
			...
			--self:Notify("You have received "..impulse.Config.XPGetVIP.." XP for playing.", "impulse/icons/star-128.png", Color(255, 240, 0))
		else
			self:AddXP(impulse.Config.XPGet)
			--self:Notify("You have received "..impulse.Config.XPGet.." XP for playing.", "impulse/icons/star-128.png", Color(255, 240, 0))
		end
	end
end