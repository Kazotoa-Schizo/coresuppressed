...
local citadelMappers = {
}

local citadelCom = {
}

local citadelTesters = {
}
...
impulse.Badges = {
	...
	--administrator = {Material("icon16/award_star_gold_1.png"), "This player is a administrator.", function(ply) return not ply:IsIncognito() and ply:IsLeadAdmin() end},
	...
	--kaz = {Material("icon16/monkey.png"), "Hi, it's me Kaz! The Founder of Citadel.", function(ply) return not ply:IsIncognito() and (ply:SteamID() == "STEAM_0:1:34022464") end},
	...
	citadeltester = {Material("icon16/bug.png"), "This player made large contributions to the testing of Citadel.", function(ply) return (citadelTesters[ply:SteamID()] or false) end},
	...
	eventteam = {Material("icon16/joystick.png"), "This player is the leader of the event team.", function(ply) return eventTeam[ply:SteamID()] end},
	...
	citadeldev = {Material("icon16/cog.png"), "This player is a Citadel Developer.", function(ply) return citadelDevs[ply:SteamID()] end},
	citadelcom = {Material("icon16/transmit.png"), "This player is a community manager. Feel free to ask them questions.", function(ply) return citadelCom[ply:SteamID()] end},
	citadelmapper = {Material("icon16/map.png"), "This player is a mapper that has collaborated with Citadel.", function(ply) return citadelMappers[ply:SteamID()] end},
}
