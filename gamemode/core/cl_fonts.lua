...
surface.CreateFont("Impulse-Elements36-Shadow", {
	font = "Arial",
	size = 36,
	weight = 800,
	antialias = true,
...
surface.CreateFont("CMBHUDElements7", {
    font = "Frak",
    size = 72,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements6", {
    font = "Frak",
    size = 60,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements5", {
    font = "Frak",
    size = 48,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements4", {
    font = "Frak",
    size = 36,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements3", {
    font = "Frak",
    size = 24,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements2", {
    font = "Frak",
    size = 18,
    weight = 400,
    antialias = true,
...
surface.CreateFont("CMBHUDElements", {
    font = "Frak",
    size = 12,
    weight = 400,
    antialias = true,
...
surface.CreateFont("SP-MenuFont", {
	font = "Verdana",
	size = 16,
	weight = 600,
	antialias = true,
...
surface.CreateFont("Impulse-Elements20-Italic", {
	font = "Arial",
	size = 20,
	weight = 800,
	italic = true,
