...
impulse.Anim.citizen_male = {
	normal = {
		...
		[ACT_MP_RUN] = {ACT_RUN, ACT_HL2MP_RUN_FAST}
	},
	pistol = {
		...
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FAST, ACT_HL2MP_RUN_PISTOL},
	...
	revolver = {
		...
		[ACT_MP_WALK] = {ACT_HL2MP_WALK, ACT_HL2MP_WALK_REVOLVER},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_HL2MP_WALK_CROUCH_REVOLVER},
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FAST, ACT_HL2MP_RUN_REVOLVER},
		attack = ACT_HL2MP_GESTURE_RANGE_ATTACK_REVOLVER,
		reload = ACT_HL2MP_GESTURE_RELOAD_PISTOL
	},
	smg = {
	...
	grenade = {
		...
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_LOW, ACT_RANGE_AIM_SMG1_LOW},
		[ACT_MP_WALK] = {ACT_HL2MP_WALK, ACT_WALK_AIM_RIFLE_STIMULATED},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_WALK_CROUCH_AIM_RIFLE},
	...
	melee = {
		...
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FAST, ACT_HL2MP_RUN_MELEE},
	...
	melee2 = {
		...
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FAST, ACT_HL2MP_RUN_MELEE2},
		attack = ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE2
	},
	slam = {
		[ACT_MP_STAND_IDLE] = {ACT_HL2MP_IDLE_SLAM, ACT_HL2MP_IDLE_SLAM},
		[ACT_MP_CROUCH_IDLE] = {ACT_HL2MP_IDLE_CROUCH_SLAM, ACT_HL2MP_IDLE_CROUCH_SLAM},
		[ACT_MP_WALK] = {ACT_HL2MP_WALK_SLAM, ACT_HL2MP_WALK_SLAM},
		[ACT_MP_CROUCHWALK] = {ACT_HL2MP_WALK_CROUCH_SLAM, ACT_HL2MP_WALK_CROUCH_SLAM},
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_SLAM, ACT_HL2MP_RUN_SLAM},
		attack = ACT_HL2MP_GESTURE_RANGE_ATTACK_SLAM
	},
	fist = {
		[ACT_MP_STAND_IDLE] = {ACT_HL2MP_IDLE_FIST, ACT_HL2MP_IDLE_FIST},
		[ACT_MP_CROUCH_IDLE] = {ACT_HL2MP_IDLE_CROUCH_FIST, ACT_HL2MP_IDLE_CROUCH_FIST},
		[ACT_MP_WALK] = {ACT_HL2MP_WALK_FIST, ACT_HL2MP_WALK_FIST},
		[ACT_MP_CROUCHWALK] = {ACT_HL2MP_WALK_CROUCH_FIST, ACT_HL2MP_WALK_CROUCH_FIST},
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FIST, ACT_HL2MP_RUN_FIST},
...
impulse.Anim.citizen_female = {
	...
	pistol = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE_PISTOL, ACT_HL2MP_IDLE_REVOLVER},
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_LOW, ACT_HL2MP_IDLE_CROUCH_REVOLVER},
...
impulse.Anim.SetModelClass("models/zippy/elitepolice.mdl", "metrocop")
...
impulse.Anim.SetModelClass("models/roots_characters/scrombine/playermodels/combine_soldier.mdl", "overwatch")
...
do
	...
	function meta:ForceSequence(sequence, callback, time, noFreeze, inverted)
		...
		if sequence and sequence > 0 then
			...
			if(inverted and inverted == true) then
				net.Start("impulseSeqInverted")
					net.WriteEntity(self)
					net.WriteBool(false)
	...
	if SERVER then
		...
		util.AddNetworkString("impulseSeqInverted")
	...
	if CLIENT then
		...
		net.Receive("impulseSeqInverted", function() -- added for ROOTs
			local ent = net.ReadEntity()
			local reset = net.ReadBool()
			local sequence = net.ReadUInt(16)
...
HOLDTYPE_TRANSLATOR["physgun"] = "slam"
	...
	if animTree then
		...
		elseif ply.OnGround(ply) then
			...
			if animTree[subClass] and animTree[subClass][act] then
				local act2 = animTree[subClass][act][ply:IsWeaponRaised() and 2 or 1] -- I may manipulate this to create tetriary animation conditionals
