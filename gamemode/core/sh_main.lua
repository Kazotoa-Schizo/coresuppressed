...
function meta:IsOwner()
    return self:SteamID() == "STEAM_0:1:34022464" or self:SteamID() == "STEAM_0:0:526890129"
end
...
function meta:Notify(message, icon, iconcol)
    if CLIENT then
        ...
        timer.Simple(notice.sEndTime or 7.5, function()
