...
if SERVER then
	function ENT:Initialize()
		self:SetModel(impulse.Config.MoneyModel)
	...
	function ENT:Use(activator)
		if activator:IsPlayer() then
            ...
            if activator:Team() == TEAM_ZOMBIE then
            	return activator:Notify("You cannot pickup items as a Zombie.")
        	end
	...
	function ENT:Draw()
		...
		--[[cam.Start3D2D(pos + ang:Up() * 1.25, ang, 0.1)
